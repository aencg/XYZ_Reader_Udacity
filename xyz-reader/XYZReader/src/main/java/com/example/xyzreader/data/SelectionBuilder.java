...
public class SelectionBuilder {
     ...
     */
    public com.example.xyzreader.data.SelectionBuilder where(String selection, String... selectionArgs) {
    ...
    public com.example.xyzreader.data.SelectionBuilder table(String table) {
        mTable = table;
        return this;
    }
